 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let nc=new tq(Z.comparator),nh=new tq(Z.comparator);function nd(...e){let t=nh;for(let r of e)t=t.insert(r.key,r);return t}function nf(e){let t=nh;return e.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function np(){return new nu(e=>e.toString(),(e,t)=>e.isEqual(t))}let nm=new tq(Z.comparator),ng=new t$(Z.comparator);function ny(...e){let t=ng;for(let r of e)t=t.add(r);return t}let nw=new t$(G);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cQ(){return new um("deleteField")}function cJ(){return new uy("serverTimestamp")}function cY(...e){return new uw("arrayUnion",e)}function cX(...e){return new uv("arrayRemove",e)}function cZ(e){return new u_("increment",e)}function c0(e){return new ua(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function c2(e,t){let r=lY(e=ea(e,lW));if(!r._uninitializedComponentsProvider||"memory"===r._uninitializedComponentsProvider._offline.kind)return S("Cannot enable indexes when persistence is disabled"),Promise.resolve();let n=function(e){let t="string"==typeof e?function(e){try{return JSON.parse(e)}catch(e){throw new D(R.INVALID_ARGUMENT,"Failed to parse JSON: "+e?.message)}}(e):e,r=[];if(Array.isArray(t.indexes))for(let e of t.indexes){let t=c4(e,"collectionGroup"),n=[];if(Array.isArray(e.fields))for(let t of e.fields){let e=uN("setIndexConfiguration",c4(t,"fieldPath"));"CONTAINS"===t.arrayConfig?n.push(new eg(e,2)):"ASCENDING"===t.order?n.push(new eg(e,0)):"DESCENDING"===t.order&&n.push(new eg(e,1))}r.push(new ed(ed.UNKNOWN_ID,t,n,ey.empty()))}return r}(t);return r.asyncQueue.enqueue(async()=>(async function(e,t){let r=e.indexManager,n=[];return e.persistence.runTransaction("Configure indexes","readwrite",e=>r.getFieldIndexes(e).next(i=>/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(function(e,t,r,n,i){t=[...t],(e=[...e]).sort(r),t.sort(r);let s=e.length,a=t.length,o=0,l=0;for(;o<a&&l<s;){let s=r(e[l],t[o]);s<0?i(e[l++]):s>0?n(t[o++]):(o++,l++)}for(;o<a;)n(t[o++]);for(;l<s;)i(e[l++])})(i,t,em,t=>{n.push(r.addFieldIndex(e,t))},t=>{n.push(r.deleteFieldIndex(e,t))})).next(()=>eS.waitFor(n)))})(await lb(r),n))}function c4(e,t){if("string"!=typeof e[t])throw new D(R.INVALID_ARGUMENT,"Missing string value for: "+t);return e[t]}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eK(e,t){return function(e,t){e._throwIfRoot("getBlob");let r=ei(e.storage,e._location,t);return e.storage.makeRequestWithTokens(r,e_).then(e=>void 0!==t?e.slice(0,t):e)}(e=(0,u.getModularInstance)(e),t)}function eH(e,t){throw Error("getStream() is only supported by NodeJS builds")}(0,l._registerComponent)(new(0,c.Component)(eR,function(e,{instanceIdentifier:t}){let r=e.getProvider("app").getImmediate(),n=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return new eC(r,n,i,t,l.SDK_VERSION)},"PUBLIC").setMultipleInstances(!0)),(0,l.registerVersion)(ek,eN,""),(0,l.registerVersion)(ek,eN,"esm2020")},{"@firebase/app":"bfE4h","@firebase/util":"cFyzG","@firebase/component":"iJpFd","@parcel/transformer-js/src/esmodule-helpers.js":"hbR2Q"}],"5hSnW":[function(e,t,r){e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);var n=e("@plasmohq/storage"),i=e("firebase/firestore"),s=e("../../utils/refreshAuthToken"),a=e("~firebase/firebaseClient");let o=e=>new Promise(t=>setTimeout(t,e)),l=async(e,t,r=3,n=3e5)=>{let i=null;for(let s=0;s<r;s++){let a=new AbortController,l=setTimeout(()=>a.abort(),n);try{let n=await fetch("https://adloops.ai/api/ai-videos/generate-from-tiktok",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify(e),credentials:"omit",signal:a.signal});if(clearTimeout(l),!n.ok&&n.status>=500&&s<r-1){i=Error(`Server responded ${n.status}`),await o(750*(s+1));continue}return{response:n}}catch(e){if(clearTimeout(l),i=e?.name==="AbortError"?Error(`request_timeout_${n}ms`):e,s<r-1){await o(750*(s+1));continue}throw i??e}}throw i??Error("Unknown network error")},u=async(e,t)=>{let r=setInterval(()=>{try{chrome.runtime?.id}catch{}},2e4),o=e=>{clearInterval(r),t.send({ok:!1,error:e})};try{let r,{url:u}=e.body??{},{prompt:c,count:h=1,duration:d=8,size:f="720x1280",fps:p,max_duration:m,adConfig:g}=e.body??{};if(!u&&e.sender?.tab?.url&&(u=e.sender.tab.url),!u||!c||!h||!d||!f)return o("missing_required_fields");let y=new n.Storage,w=await y.get("firebaseToken"),v=await y.get("firebaseUid"),_=await y.get("firebaseRefreshToken");if(!w||!v)return o("user_not_found");if((0,s.isTokenExpired)(w)){if(!_)return console.error("Token expired and no refresh token found"),o("auth_expired_no_refresh_token");{console.log("Token expired, refreshing...");let e=await (0,s.refreshAuthToken)(_);if(!e)return console.error("Failed to refresh token"),o("auth_expired_refresh_failed");w=e.id_token,await y.set("firebaseToken",e.id_token),await y.set("firebaseRefreshToken",e.refresh_token),console.log("Token refreshed successfully")}}let b=null;try{let e=await (0,i.getDoc)((0,i.doc)(a.db,"users",v));e.exists()&&(b={...e.data(),uid:v})}catch(e){console.error("Error fetching user data:",e)}let I={url:u,userId:v,prompt:c,count:h,duration:d,size:f,uploaded_by:b?.name?`[E]${b.name}`:"[EXTENSION]",language:"english"};"number"==typeof p&&(I.fps=p),"number"==typeof m&&(I.max_duration=m),g&&(I.payload=g),console.log("Sending request to generate-from-tiktok API:"),console.log("- URL:",u),console.log("- Prompt:",c),console.log("- Count:",h,"Duration:",d,"Size:",f),console.log("- FPS:",p,"Max Duration:",m),g&&console.log("- Ad Config:",JSON.stringify(g,null,2));try{let e=await l(I,w);console.log("Fetch response:",e.response),r=e.response}catch(e){return console.error("Fetch error:",e),o(e?.message||"fetch_failed")}let E=null;try{E=await r.json()}catch{let e=await r.text();return console.error("Invalid JSON response:",e),o(`invalid_json_response:${e.substring(0,100)}`)}if(!r.ok)return console.error("API responded with error:",r.status,E),o(E?.error||E?.message||`api_error_${r.status}`);t.send({ok:!0,data:E});return}catch(e){return console.error("Handler error:",e),o(e?.message||"unknown_error")}finally{clearInterval(r)}};r.default=u},{"@plasmohq/storage":"luF8G","firebase/firestore":"73OW7","../../utils/refreshAuthToken":"9ZsDl","~firebase/firebaseClient":"3tHHI","@parcel/transformer-js/src/esmodule-helpers.js":"hbR2Q"}],"4w7DT":[function(e,t,r){e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);let n=e=>{if(e instanceof Error)return e.message;try{return"string"==typeof e?e:JSON.stringify(e)}catch{return String(e)}},i=async(e,t)=>{try{let{url:r}=e.body??{};if(!r||"string"!=typeof r){t.send({ok:!1,error:"missing_url"});return}let i=await fetch("http://49.13.217.93:9000",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:"Bearer cobalt"},body:JSON.stringify({url:r})}),s=null;try{s=await i.json()}catch{let e=await i.text();t.send({ok:!1,error:`Invalid JSON response: ${e.substring(0,100)}`});return}if(!i.ok){t.send({ok:!1,error:s?.error||s?.message||`API error: ${i.status}`});return}let a="string"==typeof s?.url&&s.url.trim().length>0?s.url:null;if(!a){t.send({ok:!1,error:"missing_download_url"});return}try{let e=await chrome.downloads.download({url:a,saveAs:!1});t.send({ok:!0,status:i.status,url:a,downloadId:e})}catch(e){console.error(e),t.send({ok:!1,error:`download_failed:${n(e)}`})}}catch(e){console.error(e),t.send({ok:!1,error:`handler_failed:${n(e)}`})}};r.default=i},{"@parcel/transformer-js/src/esmodule-helpers.js":"hbR2Q"}],"7CRnJ":[function(e,t,r){e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);var n=e("@plasmohq/storage");let i=e=>{if(e instanceof Error)return e.message;try{return"string"==typeof e?e:JSON.stringify(e)}catch{return String(e)}},s=async(e,t)=>{try{let e=new n.Storage;await e.set("firebaseToken",null),await e.set("firebaseUid",null),await e.set("firebaseRefreshToken",null),t.send({ok:!0})}catch(e){console.error("removeAuth error:",e),t.send({ok:!1,error:i(e)})}};r.default=s},{"@plasmohq/storage":"luF8G","@parcel/transformer-js/src/esmodule-helpers.js":"hbR2Q"}],aP7rB:[function(e,t,r){e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);var n=e("@plasmohq/storage");let i=e=>{if(e instanceof Error)return e.message;try{return"string"==typeof e?e:JSON.stringify(e)}catch{return String(e)}},s=async(e,t)=>{try{let{token:r,uid:i,refreshToken:s}=e.body,a=new n.Storage;await a.set("firebaseToken",r),await a.set("firebaseUid",i),await a.set("firebaseRefreshToken",s),t.send({ok:!0})}catch(e){console.error("saveAuth error:",e),t.send({ok:!1,error:i(e)})}};r.default=s},{"@plasmohq/storage":"luF8G","@parcel/transformer-js/src/esmodule-helpers.js":"hbR2Q"}],iqY5N:[function(e,t,r){e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r)},{"@parcel/transformer-js/src/esmodule-helpers.js":"hbR2Q"}]},["kgW6q"],"kgW6q","parcelRequireea57"),globalThis.define=t;